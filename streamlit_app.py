...
with st.sidebar:
    ...
    selected_model = st.sidebar.selectbox('Choose a Mistral model', ['mixtral-8x7b-instruct-v0.1','old-mixtral-8x7b-instruct-v0.1','dolphin-2.2.1-mistral-7b'], key='selected_model')
    max_token = 16384
    if selected_model == 'mixtral-8x7b-instruct-v0.1':
        llm = 'mistralai/mixtral-8x7b-instruct-v0.1'
    elif selected_model == 'old-mixtral-8x7b-instruct-v0.1':
